...
@WebFilter(filterName = "FilterOperationnel", urlPatterns = {"/faces/OperationnelMarketing/*"})
public class FilterOperationnel implements Filter {
    ...
    public FilterOperationnel() {
    }    
    
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("FilterOperationnel:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("FilterOperationnel:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
       ...
       String chemin;
        chemin = req.getRequestURI().substring( req.getContextPath().length() );
...
return;
        ...
        else if ( !sess.getAttribute("role").equals("Operationnel")){
            
            res.sendRedirect(req.getContextPath() + "/faces/"+sess.getAttribute("dossier").toString()+"/acceuil.xhtml");
        }else {
            chain.doFilter(request, response);
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("FilterOperationnel: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FilterOperationnel()");
        }
        StringBuffer sb = new StringBuffer("FilterOperationnel(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("FilterOperationnel::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("FilterOperationnel::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("FilterOperationnel::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("FilterOperationnel::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("FilterOperationnel::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
